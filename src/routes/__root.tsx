...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "宏鼎集成股份有限公司 Aegis Power Integrations Co., Ltd.｜提供工程集成、AI 系統整合與 Aegis Business Apps 企業管理系統。" },
      ...
      { property: "og:site_name", content: "宏鼎集成股份有限公司" },
